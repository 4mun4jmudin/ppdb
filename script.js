...
const scriptURL = 'https://script.google.com/macros/s/AKfycbxRsXTvkeMYX3ITVxLpXP-5Xd_JdzT8s7hnQFGk9EL4d7FSRUt-0PLchTqyYZGxjcE/exec';
    ...
    input.addEventListener('change', () => {
      if (input.files && input.files.length > 0) {
        ...
        if (file.size > 10 * 1024 * 1024) {
          ...
          alert(`File "${file.name}" (${sizeMB} MB) melebihi batas maksimal 10 MB. File ditolak! Silakan pilih file yang lebih kecil.`);
          input.value = '';
